...
@method_decorator(require_permission('accounting', 'fiscalyear', 'add'), name='get')
@method_decorator(require_permission('accounting', 'fiscalyear', 'add'), name='post')
...
@method_decorator(require_permission('accounting', 'fiscalyear', 'change'), name='get')
@method_decorator(require_permission('accounting', 'fiscalyear', 'change'), name='post')
...
@method_decorator(require_permission('accounting', 'costcenter', 'view'), name='get')
...
@method_decorator(require_permission('accounting', 'costcenter', 'add'), name='get')
@method_decorator(require_permission('accounting', 'costcenter', 'add'), name='post')
...
@method_decorator(require_permission('accounting', 'costcenter', 'change'), name='get')
@method_decorator(require_permission('accounting', 'costcenter', 'change'), name='post')
...
@method_decorator(require_permission('accounting', 'journal', 'view'), name='get')
class JournalListView(LoginRequiredMixin, ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        return context
@method_decorator(require_permission('accounting', 'journal', 'add'), name='get')
@method_decorator(require_permission('accounting', 'journal', 'add'), name='post')
...
@method_decorator(require_permission('accounting', 'journal', 'change'), name='get')
@method_decorator(require_permission('accounting', 'journal', 'change'), name='post')
...
@method_decorator(require_permission('accounting', 'journal', 'approve'), name='post')
...
class HTMXJournalLineFormView(LoginRequiredMixin, View):
    @require_permission('accounting', 'journal', 'add')
...
class HTMXAccountAutocompleteView(LoginRequiredMixin, View):
    @require_permission('accounting', 'chartofaccount', 'view')
    def get(self, request):
...
# Voucher Mode Views
@method_decorator(require_permission('accounting', 'vouchermodeconfig', 'view'), name='get')
...
@method_decorator(require_permission('accounting', 'vouchermodeconfig', 'add'), name='get')
@method_decorator(require_permission('accounting', 'vouchermodeconfig', 'add'), name='post')
...
@method_decorator(require_permission('accounting', 'vouchermodeconfig', 'change'), name='get')
@method_decorator(require_permission('accounting', 'vouchermodeconfig', 'change'), name='post')
...
@method_decorator(require_permission('accounting', 'vouchermodedefault', 'add'), name='get')
@method_decorator(require_permission('accounting', 'vouchermodedefault', 'add'), name='post')
...
@method_decorator(require_permission('accounting', 'vouchermodedefault', 'change'), name='get')
@method_decorator(require_permission('accounting', 'vouchermodedefault', 'change'), name='post')
...
class VoucherEntryView(LoginRequiredMixin, View):
    ...
    @require_permission('accounting', 'voucherentry', 'add')
...
@method_decorator(require_permission('accounting', 'department', 'view'), name='get')
...
@method_decorator(require_permission('accounting', 'department', 'add'), name='get')
@method_decorator(require_permission('accounting', 'department', 'add'), name='post')
class DepartmentCreateView(LoginRequiredMixin, CreateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        return context    
@method_decorator(require_permission('accounting', 'department', 'change'), name='get')
@method_decorator(require_permission('accounting', 'department', 'change'), name='post')
...
@method_decorator(require_permission('accounting', 'chartofaccount', 'view'), name='dispatch')
class ChartOfAccountListView(LoginRequiredMixin, ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        if not org:
            ...
            context['can_add'] = PermissionUtils.has_permission(user, org, 'accounting', 'chartofaccount', 'add')
            context['can_change'] = PermissionUtils.has_permission(user, org, 'accounting', 'chartofaccount', 'change')
            context['can_delete'] = PermissionUtils.has_permission(user, org, 'accounting', 'chartofaccount', 'delete')
...
@method_decorator(require_permission('accounting', 'chartofaccount', 'add'), name='get')
@method_decorator(require_permission('accounting', 'chartofaccount', 'add'), name='post')
...
@method_decorator(require_permission('accounting', 'chartofaccount', 'change'), name='get')
@method_decorator(require_permission('accounting', 'chartofaccount', 'change'), name='post')
...
# Account Type Views
@method_decorator(require_permission('accounting', 'accounttype', 'view'), name='get')
...
@method_decorator(require_permission('accounting', 'accounttype', 'add'), name='get')
@method_decorator(require_permission('accounting', 'accounttype', 'add'), name='post')
...
@method_decorator(require_permission('accounting', 'accounttype', 'change'), name='get')
@method_decorator(require_permission('accounting', 'accounttype', 'change'), name='post')
...
# Currency Views
@method_decorator(require_permission('accounting', 'currency', 'view'), name='get')
...
@method_decorator(require_permission('accounting', 'currency', 'add'), name='get')
@method_decorator(require_permission('accounting', 'currency', 'add'), name='post')
...
@method_decorator(require_permission('accounting', 'currency', 'change'), name='get')
@method_decorator(require_permission('accounting', 'currency', 'change'), name='post')
...
@method_decorator(require_permission('accounting', 'currencyexchangerate', 'view'), name='get')
...
@method_decorator(require_permission('accounting', 'currencyexchangerate', 'add'), name='get')
@method_decorator(require_permission('accounting', 'currencyexchangerate', 'add'), name='post')
...
@method_decorator(require_permission('accounting', 'currencyexchangerate', 'change'), name='get')
@method_decorator(require_permission('accounting', 'currencyexchangerate', 'change'), name='post')
...
# Tax Authority Views
@method_decorator(require_permission('accounting', 'taxauthority', 'view'), name='get')
...
@method_decorator(require_permission('accounting', 'taxauthority', 'add'), name='get')
@method_decorator(require_permission('accounting', 'taxauthority', 'add'), name='post')
...
@method_decorator(require_permission('accounting', 'taxauthority', 'change'), name='get')
@method_decorator(require_permission('accounting', 'taxauthority', 'change'), name='post')
...
# Tax Type Views
@method_decorator(require_permission('accounting', 'taxtype', 'view'), name='get')
...
@method_decorator(require_permission('accounting', 'taxtype', 'add'), name='get')
@method_decorator(require_permission('accounting', 'taxtype', 'add'), name='post')
...
@method_decorator(require_permission('accounting', 'taxtype', 'change'), name='get')
@method_decorator(require_permission('accounting', 'taxtype', 'change'), name='post')
...
# Project Views
@method_decorator(require_permission('accounting', 'project', 'view'), name='get')
...
@method_decorator(require_permission('accounting', 'project', 'add'), name='get')
@method_decorator(require_permission('accounting', 'project', 'add'), name='post')
...
@method_decorator(require_permission('accounting', 'project', 'change'), name='get')
@method_decorator(require_permission('accounting', 'project', 'change'), name='post')
