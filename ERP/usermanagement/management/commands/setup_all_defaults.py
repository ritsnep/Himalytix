...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.WARNING(
            'WARNING: Both Nepal-specific and generic accounting defaults will be created. This may result in duplicate or overlapping data. Review create_default_data and create_defaults for potential overlap.'
        ))
        ...
        try:
            ...
            self.stdout.write(self.style.ERROR(f"Error creating generic accounting defaults: {e}"))
