...
CREATE TABLE "customer_price_lists" (
  "customer_price_list_id" SERIAL PRIMARY KEY ,
  "customer_id" INTEGER NOT NULL,
  "price_list_id" INTEGER NOT NULL,
...
CREATE TABLE "udf_field_references" (
  ...
  "field_id" INTEGER NOT NULL,
  "reference_entity_type_id" INTEGER NOT NULL,
...
CREATE TABLE "udf_field_values" (
  ...
  "date_value" DATE,
  "datetime_value" DateTime Default GetDate(),
...
CREATE TABLE "udf_multi_select_values" (
  "multi_select_id" SERIAL PRIMARY KEY ,
...
CREATE TABLE "udf_field_visibility_rules" (
  ...
  "organization_id" INTEGER NOT NULL,
  "field_id" INTEGER NOT NULL,
  "condition_field_id" INTEGER NOT NULL,
...
CREATE TABLE "udf_field_layout_items" (
  "layout_item_id" SERIAL PRIMARY KEY ,
...
CREATE TABLE "udf_calculated_fields" (
  "calculated_field_id" SERIAL PRIMARY KEY ,
  "field_id" INTEGER NOT NULL,
